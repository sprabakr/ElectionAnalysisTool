...
url="https://www.archives.gov/federal-register/electoral-college/2000/popular_vote.html"
r = requests.get(url)
...
columns = {'state':state, 'democrat': democrat, 'republican': republican, 'total_votes': total_votes,'year':2000}

# Create a dataframe from the columns variable
df = pd.DataFrame(columns)
print("imma ")
print(df)
df.to_csv("2000election.csv")