...
url="https://www.archives.gov/federal-register/electoral-college/2004/popular_vote.html"
r = requests.get(url)
...
for row in table.find_all('tr')[2:]:
   ...
   # print(hi)
    ...
    column_4 = col[5].string
    # and append it to preTestScore variable
    total_votes.append(column_4)


# Create a variable of the value of the columns
columns = {'state':state, 'democrat': democrat, 'republican': republican, 'total_votes': total_votes,'year':2004}

# Create a dataframe from the columns variable
df = pd.DataFrame(columns)
print("imma ")
print(df)
df.to_csv("2004election.csv")