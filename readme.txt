...
This webapp performs queries based on user's parameter inputs. The data and query inputs are from 2000-2016. These are the queries this web app performs currently:
